...
public class Admin_screen1Controller implements Initializable {
	...
	@FXML
	JFXToggleButton valvela, valvelb, valvelc, valveld, valvele, valvelf,
			valvelg, valvelh;
	...
	String va = "0", vb = "low", vc = "0", vd = "0", ve = "0", vf = "0",
			vg = "0", vh = "0", pc = "0", fc = "0";

	@Override
	public void initialize(URL location, ResourceBundle resources) {

		/*Set latching and Non latching Valve*/
		...
		btnapply.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				String query = "update admin_screen1 set va='" + va + "',vb='"
						+ vb + "',vc='" + vc + "',vd='" + vd + "',ve='" + ve
						+ "',vf='" + vf + "',vg='" + vg + "',vh='" + vh
						+ "',pc='" + pc + "',fc='" + fc + "'";
				...
				Toast.makeText(Main.mainstage, "Successfully Set....", 1000,
						200, 200);
